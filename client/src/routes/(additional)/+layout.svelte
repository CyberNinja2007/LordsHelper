...
<nav class="navbar fixed-top" bind:this={navbar}>
  ...
  >
    ...
    >
      ...
      >
        <li>
          <a class="nav-link" href="/" on:click={openNavbar}>Главная </a><span
            class="sr-only">(current)</span
          >
        </li>
        <li>
          <a class="nav-link" href="/#features" on:click={openNavbar}
            >Преимущества</a
          >
        </li>
        <li>
          <a class="nav-link" href="/#details" on:click={openNavbar}
            >Подробнее</a
          >
        </li>
        <li>
          <a class="nav-link" href="/#faq" on:click={openNavbar}>FAQ</a>
        </li>
        <li>
          <a class="nav-link" href="/#pricing" on:click={openNavbar}>Цены</a>
        </li>
        <li>
